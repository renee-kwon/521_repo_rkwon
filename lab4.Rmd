...
creating an alert block that will make the question show up with a blue
background in the HTML output. Unfortunately, this creates an error when
exporting to PDF, so it can only be used for HTML.
...
<https://github.ubc.ca/MDS-2022-23/DSCI_521_lab4_rkwon>
...
[**https://renee-kwon.github.io/Lab4Q1/**](https://renee-kwon.github.io/Lab4Q1/)
...
```{r Q4OptionFalse, include=FALSE}
print(x+y)
```

```{r Q4OptionTrue, include=TRUE}
print(x+y)
```

> *With the "include" option, if set to false (include=FALSE), the
> output document will not include whatever is written in the code
> chunk, but the code is still evaluated. If set to TRUE, the output
> will appear in the output document (default is true). Therefore in our
> example, codechunk named "Q4OptionTrue" and it's output is shown on
> the document but "Q4OptionFalse" is not shown as it's include option
> is set to false.*
...
```{r Q5ChunkOptions, error=TRUE, comment='##'}

print(x+y)
print(x+c)
```

> *The "comment" option allows you to select a character string to be
> printed in front of the code and output of that chunk in our output
> document. In our case, we chose "\##" as the character string, so the
> output document will print a "\##" our output, "6", above.*
>
> *The "error" option, enables display of error messages in the output
> document. In our case, our error code returned for "print(x+c)" is
> displayed because we have set the "error" option to TRUE above.*
...
> [*https://github.ubc.ca/MDS-2022-23/DSCI_521_lab4_rkwon/blob/master/lab4_HTML.html*](https://github.ubc.ca/MDS-2022-23/DSCI_521_lab4_rkwon/blob/master/lab4_HTML.html)
>
> [*https://github.ubc.ca/MDS-2022-23/DSCI_521_lab4_rkwon/blob/master/lab4_PDF.pdf*](https://github.ubc.ca/MDS-2022-23/DSCI_521_lab4_rkwon/blob/master/lab4_PDF.pdf)
...
> [*https://github.ubc.ca/MDS-2022-23/DSCI_521_lab4_rkwon/blob/master/Lab4Question8.Rmd*](https://github.ubc.ca/MDS-2022-23/DSCI_521_lab4_rkwon/blob/master/Lab4Question8.Rmd)
>
> [*https://github.ubc.ca/MDS-2022-23/DSCI_521_lab4_rkwon/blob/master/Lab4Question8.html*](https://github.ubc.ca/MDS-2022-23/DSCI_521_lab4_rkwon/blob/master/Lab4Question8.html)
...
[*https://github.ubc.ca/MDS-2022-23/DSCI_521_lab4_rkwon/blob/master/Lab4Question8.md*](https://github.ubc.ca/MDS-2022-23/DSCI_521_lab4_rkwon/blob/master/Lab4Question8.md){.uri}

*The file is rendered as an HTML file so it is viewable on github.com.*
